...
from maga_wish.shared.mocks.app import app, client
from maga_wish.shared.mocks.services.get_user_by_email_service_mock import mock_get_user_by_email_service
